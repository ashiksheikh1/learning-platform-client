          ...
          >
            <div className="rounded-3xl border border-gray-200 bg-white/80 p-5 shadow-2xl backdrop-blur dark:border-gray-800 dark:bg-gray-900/80">
              ...
              <div className="mb-5 flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500">Learning Overview</p>
              ...
              {/* Fake chart */}
              <div className="flex h-52 items-end gap-4 rounded-2xl bg-gray-50 p-5 dark:bg-gray-950">
                {[45, 70, 55, 85, 65, 95, 78].map((height, index) => (
                  <motion.div
                    key={index}
                    initial={{ height: 0 }}
              ...
              <div className="mt-5 grid grid-cols-3 gap-3">
                ...
                <div className="rounded-xl bg-red-50 p-4 dark:bg-red-950/40">
                  <p className="text-xs text-gray-500">Improve</p>
